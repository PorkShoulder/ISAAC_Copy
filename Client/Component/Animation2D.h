...
public:
	...
	bool AddSequeunce(const std::string& name, const std::vector<std::wstring>& filenames, bool loop = false, bool reverse = false, float playTime = 1.f, float playRate = 1.f);
	bool AddSequeunce(const std::string& name, const std::wstring& filename, const std::vector<FVector4D>& frames, bool loop = false, bool reverse = false, float playTime = 1.f, float playRate = 1.f);
